#pragma checksum "D:\Projects\C#\TextQuest\TextQuest\TextQuest\Views\GamePage\_GetSceneObjects.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "eb3fe2ab78cebf4e57d39dc3510f4c1722add218"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"eb3fe2ab78cebf4e57d39dc3510f4c1722add218", @"/Views/GamePage/_GetSceneObjects.cshtml")]
...
#line hidden
            EndContext();
            BeginContext(5465, 1, true);
            WriteLiteral(",");
            EndContext();
            BeginContext(5467, 18, false);
#line 113 "D:\Projects\C#\TextQuest\TextQuest\TextQuest\Views\GamePage\_GetSceneObjects.cshtml"
            ...
            WriteLiteral(@")"")).attr(""oncontextmenu"", String(""ShowInfo("" + item.newId + "");return false;"")))));
                            ...
                            $('#scContainer').append($(""<div>"").attr(""id"", String(item.newId)).addClass(""sceneObject"").css(""position"", ""absolute"").css(""left"", item.x).css(""top"", item.y).attr(""onmouseover"", String(""ShowAction("" + ShowAction(item.newId) + "")"")).attr(""title"", item.name) //todo: не ставится hover text
                                .append($(""<a>"")
                                    .append($(""<img>"").attr(""src"", item.imageUrl).attr(""onclick"", String(""scObjHandler("" + item.newId + "",");
            EndContext();
            BeginContext(6209, 21, false);
#line 120 "D:\Projects\C#\TextQuest\TextQuest\TextQuest\Views\GamePage\_GetSceneObjects.cshtml"
                                                                                                                                     Write(Model.CurrentScene.Id);
...
<script>
    function findCombination(id) {
        ...
        $("".innerText"").append(document.createTextNode($(""#"" + id + ");
            WriteLiteral(@""".sceneObject"").attr(""title"")));
